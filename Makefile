...
install-data:
	...
	install -Dm644 data/icons/hicolor/scalable/mimetypes/application-x-pkcs7-mime.svg $(PREFIX)/share/icons/hicolor/scalable/mimetypes/application-x-pkcs7-mime.svg
